...
## Corpus Check
- 98 files · ~78,336 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 726 nodes · 815 edges · 93 communities (85 shown, 8 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 22 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bc89f2cd`
...
6. `2026-09-23 — Widget metadata and optional LaTeX templates` - 11 edges
...
## Knowledge Gaps
- **476 isolated node(s):** `github.com/berdsa/mathprep_schema`, `answer_widget`, `start-local.sh script`, `What this repo is`, `Source of truth` (+471 more)
