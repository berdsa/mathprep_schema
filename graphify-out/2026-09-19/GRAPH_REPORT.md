...
## Corpus Check
- 24 files · ~13,311 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 163 nodes · 162 edges · 25 communities (24 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `edc5f6dd`
...
Cohesion: 0.20
Nodes (9): 2026-09-19 — Phase 0 base DDL, 2026-09-19 — Phase 0 dictionary seeds, 2026-09-19 — Phase 0 forbidden-write probes, 2026-09-19 — Phase 0 idempotency constraints, 2026-09-19 — Phase 0 migration plan, 2026-09-19 — Phase 0 migration verification, 2026-09-19 — Phase 0 service roles and grants, 2026-09-19 — Repository initialization (+1 more)
...
## Knowledge Gaps
- **104 isolated node(s):** `grade_band`, `event_log`, `What this repo is`, `Source of truth`, `Stack` (+99 more)
