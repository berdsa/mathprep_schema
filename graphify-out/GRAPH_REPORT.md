...
## Corpus Check
- 31 files · ~25,550 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 285 nodes · 371 edges · 29 communities (27 shown, 2 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3d0f5a56`
...
1. `07 — Wave-A Exemplar Task-Type Specs` - 46 edges
...
Cohesion: 0.04
Nodes (46): 07 — Wave-A Exemplar Task-Type Specs, G1-NUM-001 — Addition within range, G1-NUM-002 — Subtraction within range, G1-NUM-003 — Number comparison, G1-NUM-004 — Missing addend, G1-NUM-005 — Simple word problem (addition/subtraction), G1-NUM-006 — Place value, G1-NUM-007 — Ordering a list (+38 more)
...
## Knowledge Gaps
- **161 isolated node(s):** `github.com/berdsa/mathprep_schema`, `event_log`, `What this repo is`, `Source of truth`, `Stack` (+156 more)
