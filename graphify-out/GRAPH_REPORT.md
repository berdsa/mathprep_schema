# Graph Report - schema  (2026-09-19)

## Corpus Check
- 24 files · ~13,364 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 164 nodes · 163 edges · 25 communities (24 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `769feef8`
...
1. `Editing this README` - 14 edges
2. `Agent log` - 10 edges
3. `02 — Requirements` - 10 edges
...
### Community 0 - "Editing this README"
Cohesion: 0.14
Nodes (14): Authors and acknowledgment, Badges, Contributing, Description, Editing this README, Installation, License, Name (+6 more)
...
### Community 12 - "mathprep_schema"
Cohesion: 0.29
Nodes (6): Add your files, Collaborate with your team, Getting started, Integrate with your tools, mathprep_schema, Test and Deploy
...
Cohesion: 0.18
Nodes (10): 2026-09-19 — Phase 0 base DDL, 2026-09-19 — Phase 0 dictionary seeds, 2026-09-19 — Phase 0 forbidden-write probes, 2026-09-19 — Phase 0 idempotency constraints, 2026-09-19 — Phase 0 migration plan, 2026-09-19 — Phase 0 migration verification, 2026-09-19 — Phase 0 service roles and grants, 2026-09-19 — Phase 0 summary (+2 more)
...
## Knowledge Gaps
- **105 isolated node(s):** `grade_band`, `event_log`, `What this repo is`, `Source of truth`, `Stack` (+100 more)
...
- **Why does `Editing this README` connect `Editing this README` to `mathprep_schema`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **What connects `grade_band`, `event_log`, `What this repo is` to the rest of the system?**
  _105 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Editing this README` be split into smaller, more focused modules?**
