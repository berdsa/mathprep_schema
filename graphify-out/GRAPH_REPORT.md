...
## Corpus Check
- 40 files · ~56,431 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 604 nodes · 731 edges · 37 communities (35 shown, 2 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 19 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `52dfb378`
...
Cohesion: 0.06
Nodes (31): `200 OK`, request `DONE` with a task set, `200 OK`, request not `DONE`, `200 OK` response, `202 Accepted`, `400 Bad Request`, `400 Bad Request`, `401 Unauthorized`, `401 Unauthorized` (+23 more)
...
## Knowledge Gaps
- **435 isolated node(s):** `github.com/berdsa/mathprep_schema`, `What this repo is`, `Source of truth`, `Stack`, `Local infra` (+430 more)
