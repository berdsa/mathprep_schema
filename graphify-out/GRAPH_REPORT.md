...
## Corpus Check
- 100 files · ~78,546 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 729 nodes · 816 edges · 95 communities (87 shown, 8 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 22 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `15701580`
...
6. `2026-09-23 — Widget metadata and optional LaTeX templates` - 12 edges
...
## Knowledge Gaps
- **477 isolated node(s):** `github.com/berdsa/mathprep_schema`, `answer_widget`, `start-local.sh script`, `What this repo is`, `Source of truth` (+472 more)
