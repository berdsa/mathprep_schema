...
## Corpus Check
- 35 files · ~38,622 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 407 nodes · 517 edges · 33 communities (31 shown, 2 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `36d954cb`
...
1. `07 — Wave-A Exemplar Task-Type Specs` - 108 edges
2. `Agent log` - 78 edges
3. `Result` - 17 edges
4. `Validate()` - 15 edges
...
Cohesion: 0.02
Nodes (108): 07 — Wave-A Exemplar Task-Type Specs, G10-CAL-001 — Basic limit, G10-PRO-001 — Basic single-event probability, G10-PRO-002 — Compound probability, G10-TRG-001 — Trigonometric equation, G11-ALG-001 — Linear system via matrices, G11-FUN-001 — Exponential equation, G11-LOG-001 — Logarithmic equation (+100 more)

### Community 1 - "Agent log"
Cohesion: 0.03
Nodes (78): 2026-09-19 — Phase 0 base DDL, 2026-09-19 — Phase 0 dictionary seeds, 2026-09-19 — Phase 0 forbidden-write probes, 2026-09-19 — Phase 0 idempotency constraints, 2026-09-19 — Phase 0 migration plan, 2026-09-19 — Phase 0 migration verification, 2026-09-19 — Phase 0 service roles and grants, 2026-09-19 — Phase 0 summary (+70 more)
...
## Knowledge Gaps
- **265 isolated node(s):** `github.com/berdsa/mathprep_schema`, `event_log`, `What this repo is`, `Source of truth`, `Stack` (+260 more)
