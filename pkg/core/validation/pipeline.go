...
func ValidateBool(raw, correctAnswer string) Result {
	canonical := map[string]string{"<": "<", "less": "<", "less than": "<", ">": ">", "greater": ">", "greater than": ">", "=": "=", "equal": "=", "equal to": "=", "true": "TRUE", "false": "FALSE", "red": "red", "blue": "blue", "green": "green", "cm": "cm", "kg": "kg", "l": "L", "2d": "2D", "3d": "3D", "square": "square", "triangle": "triangle", "pentagon": "pentagon", "hexagon": "hexagon"}
