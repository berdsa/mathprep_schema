...
## G2-NUM-013 — Ones digit

| Field | Value |
|---|---|
| Title / domain / grade / Bloom | Identify the ones digit / NUM / 2 / Understand |
| spec_version / generation_mode / locale | 1.0.0-draft / CODE / `ru-KZ` |
| render_target / template | `plaintext`, `unicode-math` / `What digit is in the ones place of {n}?` |
| Variables / constraint | `n∈[10,99]` |
...
## G2-NUM-022 — Ten less than n

| Field | Value |
|---|---|
| Title / domain / grade / Bloom | Subtract ten from a number / NUM / 2 / Understand |
| spec_version / generation_mode / locale | 1.0.0-draft / CODE / `ru-KZ` |
| render_target / template | `plaintext`, `unicode-math` / `What is 10 less than {n}?` |
| Variables / constraint | `n∈[10,99]` |
| Solution / equivalence_policy | `n−10`; **STRICT-FORM** EXACT-INT |
...
## G2-NUM-027 — Number from tens and ones

| Field | Value |
|---|---|
| Title / domain / grade / Bloom | Construct a number from place values / NUM / 2 / Understand |
| spec_version / generation_mode / locale | 1.0.0-draft / CODE / `ru-KZ` |
| render_target / template | `plaintext`, `unicode-math` / `What number has {t} tens and {o} ones?` |
...
## G2-NUM-039..047 — Groups, comparison, parity, and multiplication facts

| Field | Value |
|---|---|
| Title / domain / grade / Bloom | Grade 2 number operations / NUM / 2 / Apply |
| spec_version / generation_mode / locale | 1.0.0-draft / CODE / `ru-KZ` |
| render_target / templates | `plaintext`, `unicode-math`; each prompt displays every operand and requested relation |
